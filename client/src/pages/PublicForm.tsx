  ...
  if (showThankYou) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <Card className="w-full max-w-md mx-auto bg-white/75 backdrop-blur-md border-municipal-border/30 shadow-lg">
    ...
    <div className="min-h-screen py-4 px-4 flex flex-col overflow-x-hidden">
      ...
      <div className="mt-8 space-y-4">
        ...
        <div className="px-4 py-3 bg-black/20 backdrop-blur-sm rounded-lg text-xs text-white/80 leading-relaxed">
          ...
          <p className="mb-2">
            Käyttämällä tätä palvelua hyväksyt, että ilmoittamasi tiedot ja lähettämäsi kuvat käsitellään palvelun tarjoajan toimesta viihtyisyyden parantamiseksi ja töhryjen poistamisen edistämiseksi. Käytämme tietoja vain mahdollisen ilmoituksen tilapäivitysten lähettämiseen. Kaikki ilmoitukset tarkistetaan ja asiattomat ilmoitukset poistetaan ilman ennakkoilmoitusta. Palvelu ei takaa välitöntä toimenpiteiden aloittamista.
          </p>
          <p>
